...
public class RegisterForm extends JFrame {
    ...
    public RegisterForm() {
        ...
        btnPhoto.setBackground(new Color(206, 115, 244));
        btnPhoto.setForeground(Color.WHITE);

        btnSave.setBackground(new Color(116, 189, 239));
        btnSave.setForeground(Color.WHITE);

        btnBack.setBackground(new Color(244, 144, 207));
    ...
    private void saveUser() {
        ...
        String sql = """
            INSERT INTO Users(username,password,first_name,last_name,email,date_of_birth,photo)
            VALUES(?,?,?,?,?,?,?)
        """;
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            ps.setString(5, txtUsername.getText() + "@mail.com");
